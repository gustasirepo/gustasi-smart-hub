            ...
            <div className="relative animate-fade-up" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 w-48 lg:w-56 group">
                  <div className="relative bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-2 border border-amber-200/30">
                    <img 
                ...
                <div className="absolute -bottom-8 -left-6 bg-white/90 backdrop-blur-md border border-amber-200/30 rounded-2xl p-4 animate-bounce-gentle shadow-lg" style={{ animationDelay: '1s' }}>
                ...
                <div className="absolute top-3/4 left-4 bg-white/90 backdrop-blur-md border border-blue-200/30 rounded-2xl px-3 py-2 animate-bounce-gentle shadow-lg" style={{ animationDelay: '2.5s' }}>
